...
const translations: Record<string, Record<TranslationKey, string>> = {
  "zh-CN": {
    ...
    "arrangements.subtitle": "放下之后需要关注的事",
    "arrangements.emptyTitle": "还没有安排",
    "arrangements.emptyDesc": "之后需要关注、确认或落地的事，可以先放在这里。",
    "arrangements.create": "新建安排",
    "arrangements.new": "新建",
    "arrangements.createTitle": "新建安排",
    "arrangements.createSubtitle": "先把之后需要关注的事放下来",
    "arrangements.fieldTitle": "标题",
    "arrangements.fieldTime": "时间描述",
    "arrangements.fieldNote": "备注",
    "arrangements.titlePlaceholder": "例如：周末整理体检报告",
    "arrangements.timePlaceholder": "例如：这周六上午",
    "arrangements.notePlaceholder": "补充地点、背景或需要确认的事",
    "arrangements.save": "保存安排",
    "arrangements.cancel": "取消",
    "arrangements.closeCreate": "关闭新建安排",
    "arrangements.timeScope": "时间尺度",
    "arrangements.scopeDay": "日",
    "arrangements.scopeWeek": "周",
    "arrangements.scopeMonth": "月",
    "arrangements.scopeYear": "年",
    "arrangements.dayEmptyTitle": "今天还没有安排",
    "arrangements.dayEmptyDesc": "今天或近期真正要处理的事，可以先放在这里。",
    "arrangements.weekEmptyTitle": "本周还没有安排",
    "arrangements.weekEmptyDesc": "本周需要留意的安排会出现在这里。",
    "arrangements.monthEmptyTitle": "本月还没有安排",
    "arrangements.monthEmptyDesc": "本月需要留意的安排会出现在这里。",
    "arrangements.yearEmptyTitle": "今年还没有安排",
    "arrangements.yearEmptyDesc": "今年或长期需要留意的安排会出现在这里。",
    "arrangements.weekOverview": "本周需要留意的安排",
    "arrangements.monthOverview": "本月需要留意的安排",
    "arrangements.yearOverview": "今年或长期需要留意的安排",
    "arrangements.stowed": "已放下",
    "arrangements.closeStowed": "关闭已放下",
    "arrangements.stowedTitle": "已放下",
    "arrangements.stowedSubtitle": "暂时放下或已经完成的安排",
    "arrangements.stowedEmptyTitle": "还没有放下的安排",
    "arrangements.stowedEmptyDesc": "完成或以后再说的安排会收纳在这里。",
    "arrangements.laterGroupTitle": "以后再说",
    "arrangements.completedGroupTitle": "已完成",
    "arrangements.statusPending": "待关注",
    "arrangements.statusCompleted": "已完成",
    "arrangements.statusLater": "以后再说",
    "arrangements.complete": "完成",
    "arrangements.moveLater": "以后再说",
    "arrangements.refocus": "重新关注",
    "arrangements.sourceManual": "手动创建",
    "insight.title": "洞见",
  ...
  "zh-TW": {
    ...
    "arrangements.title": "安排",
    "arrangements.subtitle": "放下之後需要關注的事",
    "arrangements.emptyTitle": "還沒有安排",
    "arrangements.emptyDesc": "之後需要關注、確認或落地的事，可以先放在這裡。",
    "arrangements.create": "新建安排",
    "arrangements.new": "新建",
    "arrangements.createTitle": "新建安排",
    "arrangements.createSubtitle": "先把之後需要關注的事放下來",
    "arrangements.fieldTitle": "標題",
    "arrangements.fieldTime": "時間描述",
    "arrangements.fieldNote": "備註",
    "arrangements.titlePlaceholder": "例如：週末整理體檢報告",
    "arrangements.timePlaceholder": "例如：這週六上午",
    "arrangements.notePlaceholder": "補充地點、背景或需要確認的事",
    "arrangements.save": "儲存安排",
    "arrangements.cancel": "取消",
    "arrangements.closeCreate": "關閉新建安排",
    "arrangements.timeScope": "時間尺度",
    "arrangements.scopeDay": "日",
    "arrangements.scopeWeek": "週",
    "arrangements.scopeMonth": "月",
    "arrangements.scopeYear": "年",
    "arrangements.dayEmptyTitle": "今天還沒有安排",
    "arrangements.dayEmptyDesc": "今天或近期真正要處理的事，可以先放在這裡。",
    "arrangements.weekEmptyTitle": "本週還沒有安排",
    "arrangements.weekEmptyDesc": "本週需要留意的安排會出現在這裡。",
    "arrangements.monthEmptyTitle": "本月還沒有安排",
    "arrangements.monthEmptyDesc": "本月需要留意的安排會出現在這裡。",
    "arrangements.yearEmptyTitle": "今年還沒有安排",
    "arrangements.yearEmptyDesc": "今年或長期需要留意的安排會出現在這裡。",
    "arrangements.weekOverview": "本週需要留意的安排",
    "arrangements.monthOverview": "本月需要留意的安排",
    "arrangements.yearOverview": "今年或長期需要留意的安排",
    "arrangements.stowed": "已放下",
    "arrangements.closeStowed": "關閉已放下",
    "arrangements.stowedTitle": "已放下",
    "arrangements.stowedSubtitle": "暫時放下或已經完成的安排",
    "arrangements.stowedEmptyTitle": "還沒有放下的安排",
    "arrangements.stowedEmptyDesc": "完成或以後再說的安排會收納在這裡。",
    "arrangements.laterGroupTitle": "以後再說",
    "arrangements.completedGroupTitle": "已完成",
    "arrangements.statusPending": "待關注",
    "arrangements.statusCompleted": "已完成",
    "arrangements.statusLater": "以後再說",
    "arrangements.complete": "完成",
    "arrangements.moveLater": "以後再說",
    "arrangements.refocus": "重新關注",
    "arrangements.sourceManual": "手動建立",
    "insight.title": "洞見",
  ...
  "en-US": {
    ...
    "arrangements.title": "Arrangements",
    "arrangements.subtitle": "Things to come",
    "arrangements.emptyTitle": "No arrangements yet",
    "arrangements.emptyDesc": "Future things that need attention, confirmation, or follow-through can live here.",
    "arrangements.create": "New arrangement",
    "arrangements.new": "New",
    "arrangements.createTitle": "New arrangement",
    "arrangements.createSubtitle": "Set down something that needs attention later",
    "arrangements.fieldTitle": "Title",
    "arrangements.fieldTime": "Time",
    "arrangements.fieldNote": "Note",
    "arrangements.titlePlaceholder": "Example: organize health report this weekend",
    "arrangements.timePlaceholder": "Example: Saturday morning",
    "arrangements.notePlaceholder": "Add place, context, or things to confirm",
    "arrangements.save": "Save arrangement",
    "arrangements.cancel": "Cancel",
    "arrangements.closeCreate": "Close new arrangement",
    "arrangements.timeScope": "Time scope",
    "arrangements.scopeDay": "Day",
    "arrangements.scopeWeek": "Week",
    "arrangements.scopeMonth": "Month",
    "arrangements.scopeYear": "Year",
    "arrangements.dayEmptyTitle": "No day arrangements",
    "arrangements.dayEmptyDesc": "Things for today or the near term can live here.",
    "arrangements.weekEmptyTitle": "No week arrangements",
    "arrangements.weekEmptyDesc": "This week's arrangements to keep in mind will appear here.",
    "arrangements.monthEmptyTitle": "No month arrangements",
    "arrangements.monthEmptyDesc": "This month's arrangements to keep in mind will appear here.",
    "arrangements.yearEmptyTitle": "No year arrangements",
    "arrangements.yearEmptyDesc": "This year's or longer-term arrangements will appear here.",
    "arrangements.weekOverview": "This week's arrangements to keep in mind",
    "arrangements.monthOverview": "This month's arrangements to keep in mind",
    "arrangements.yearOverview": "This year's or long-term arrangements to keep in mind",
    "arrangements.stowed": "Stowed",
    "arrangements.closeStowed": "Close stowed arrangements",
    "arrangements.stowedTitle": "Stowed",
    "arrangements.stowedSubtitle": "Things set aside or already completed",
    "arrangements.stowedEmptyTitle": "No stowed arrangements yet",
    "arrangements.stowedEmptyDesc": "Completed or later arrangements will live here.",
    "arrangements.laterGroupTitle": "Later",
    "arrangements.completedGroupTitle": "Completed",
    "arrangements.statusPending": "Pending",
    "arrangements.statusCompleted": "Completed",
    "arrangements.statusLater": "Later",
    "arrangements.complete": "Complete",
    "arrangements.moveLater": "Later",
    "arrangements.refocus": "Refocus",
    "arrangements.sourceManual": "Manual",
  ...
  "ar-SA": {
    ...
    "tabs.insight": "رؤى",
    "tabs.mine": "أنا",
    "arrangements.title": "ترتيبات",
    "arrangements.subtitle": "أمور تحتاج إلى انتباه لاحقا",
    "arrangements.emptyTitle": "لا توجد ترتيبات بعد",
    "arrangements.emptyDesc": "يمكن وضع الأمور المستقبلية التي تحتاج إلى انتباه أو تأكيد أو متابعة هنا.",
    "arrangements.create": "ترتيب جديد",
    "arrangements.new": "جديد",
    "arrangements.createTitle": "ترتيب جديد",
    "arrangements.createSubtitle": "ضع أمرا يحتاج إلى انتباه لاحقا",
    "arrangements.fieldTitle": "العنوان",
    "arrangements.fieldTime": "وصف الوقت",
    "arrangements.fieldNote": "ملاحظة",
    "arrangements.titlePlaceholder": "مثال: ترتيب تقرير الفحص في نهاية الأسبوع",
    "arrangements.timePlaceholder": "مثال: صباح السبت",
    "arrangements.notePlaceholder": "أضف المكان أو السياق أو ما يحتاج إلى تأكيد",
    "arrangements.save": "حفظ الترتيب",
    "arrangements.cancel": "إلغاء",
    "arrangements.closeCreate": "إغلاق ترتيب جديد",
    "arrangements.timeScope": "النطاق الزمني",
    "arrangements.scopeDay": "يوم",
    "arrangements.scopeWeek": "أسبوع",
    "arrangements.scopeMonth": "شهر",
    "arrangements.scopeYear": "سنة",
    "arrangements.dayEmptyTitle": "لا توجد ترتيبات لليوم",
    "arrangements.dayEmptyDesc": "يمكن وضع أمور اليوم أو المستقبل القريب هنا.",
    "arrangements.weekEmptyTitle": "لا توجد ترتيبات لهذا الأسبوع",
    "arrangements.weekEmptyDesc": "ستظهر هنا ترتيبات هذا الأسبوع التي تحتاج إلى انتباه.",
    "arrangements.monthEmptyTitle": "لا توجد ترتيبات لهذا الشهر",
    "arrangements.monthEmptyDesc": "ستظهر هنا ترتيبات هذا الشهر التي تحتاج إلى انتباه.",
    "arrangements.yearEmptyTitle": "لا توجد ترتيبات لهذا العام",
    "arrangements.yearEmptyDesc": "ستظهر هنا ترتيبات هذا العام أو المدى الطويل.",
    "arrangements.weekOverview": "ترتيبات هذا الأسبوع التي تحتاج إلى انتباه",
    "arrangements.monthOverview": "ترتيبات هذا الشهر التي تحتاج إلى انتباه",
    "arrangements.yearOverview": "ترتيبات هذا العام أو المدى الطويل التي تحتاج إلى انتباه",
    "arrangements.stowed": "موضوع جانبا",
    "arrangements.closeStowed": "إغلاق الموضوع جانبا",
    "arrangements.stowedTitle": "موضوع جانبا",
    "arrangements.stowedSubtitle": "ترتيبات مؤجلة أو مكتملة",
    "arrangements.stowedEmptyTitle": "لا توجد ترتيبات موضوعة جانبا",
    "arrangements.stowedEmptyDesc": "ستظهر الترتيبات المكتملة أو المؤجلة هنا.",
    "arrangements.laterGroupTitle": "لاحقا",
    "arrangements.completedGroupTitle": "مكتمل",
    "arrangements.statusPending": "قيد المتابعة",
    "arrangements.statusCompleted": "مكتمل",
    "arrangements.statusLater": "لاحقا",
    "arrangements.complete": "إكمال",
    "arrangements.moveLater": "لاحقا",
    "arrangements.refocus": "إعادة المتابعة",
    "arrangements.sourceManual": "يدوي",
